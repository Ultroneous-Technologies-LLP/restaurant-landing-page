...
export const CalendarInput: FC<CustomInputProps> = ({ label, placeholder }) => {
  ...
  return (
    <div className="mb-4">
      ...
      <div className="p-4 border border-[#CECCCA] rounded-full flex gap-4 items-center relative">
        ...
        <input
          ...
          id={label}
          type="date"
          className="font-inter text-base/4 text-[#A9A6A6] focus:outline-none w-full"
          value={value}
