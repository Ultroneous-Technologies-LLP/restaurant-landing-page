...
import { Container, Title, Cart } from "@/components";
...
export const MostPopularDishes: FC<MostPopularDishesProps> = ({ dishes, title }) => (
  <Container className="px-4 py-20 md:px-6 md:py-30 xl:px-18 xl:py-37.5">
    <Title className="pb-8 xl:pb-25" title={title} />
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
      {dishes.map(({ alt, description, id, image, price, title: dishesTitle }) => (
        <div
